...
namespace Dormate.API.Services
{
    ...
    public class MailService : IMailService
    {
        public Task SendEmailAsync(string email, string subject, string htmlMessage)
        {
            ...
            emailToSend.From.Add(new MailboxAddress("CMMS", "dat.nt271102@gmail.com"));
        ...
        background-color: #efc15f5c;"">
            <div class=""header"" style=""margin-top: 50px;"">
                <div class=""logo""
                    ...
                    <img src=""https://cdn.prod.website-files.com/65cda65f0af1fe67dc20dfeb/66b4a1e5b70f6c33816918e6_CMMS%20for%20Facility%20Management_%20Applications%2C%20Benefits%2C%20and%20Industry-Specific%20Solutions.png""
                        alt=""Logo"" srcset="""" style=""width: 100%; height: 100%; margin: 10px 5px 15px 60px;"">
                </div>
                <div class=""text"" style=""text-align: center;"">
                    <h1>Chào mừng bạn đến với CMMS</h1>
                    <a href=" + htmlMessage + @" 
            ...
            <div class=""footer"" style=""display: flex;  margin-top: 200px;"">
                <div class=""footercontent"" style=""width: 480px; text-align: center; margin: 0px auto;"">
                    <div class=""span1"" style=""margin-top: 10px; margin-bottom: 10px;"">
                        <span>Copyright © 2024 CMMS, Allrights reserved.</span>
                    </div>
                    ...
                    <div class=""span3"" style=""margin-top: 10px;"">
                        <span>Email: cmms4091@gmail.com</span>
                    </div>
